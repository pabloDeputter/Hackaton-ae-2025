...
/***/ (function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(1), __webpack_require__(17), __webpack_require__(6)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, MapMesh_1, DefaultMapViewController_1, Grid_1) {
	    "use strict";
	...
	!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(2), __webpack_require__(3), __webpack_require__(4), __webpack_require__(5), __webpack_require__(6), __webpack_require__(8), __webpack_require__(9), __webpack_require__(10), __webpack_require__(11), __webpack_require__(12)], __WEBPACK_AMD_DEFINE_RESULT__ = function (require, exports, interfaces_1, hexagon_1, three_1, coords_1, Grid_1, land_fragment_1, land_vertex_1, mountains_fragment_1, mountains_vertex_1, Forests_1) {
	    ...
	    function isNextOrPrevRiverTile(grid, tile, q, r, coastCount) {
	        ...
	        if (neighbor && neighbor.rivers && tile && tile.rivers) {
	            for (var _i = 0, _a = tile.rivers; _i < _a.length; _i++) {
	                var self_1 = _a[_i];
	                for (var _b = 0, _c = neighbor.rivers; _b < _c.length; _b++) {
	                    var other = _c[_b];
	                    var sameRiver = self_1.riverIndex == other.riverIndex &&
	                        Math.abs(self_1.riverTileIndex - other.riverTileIndex) == 1;
	                    var otherRiver = self_1.riverIndex != other.riverIndex && sameRiver;
	    ...
	    function computeRiverTextureIndex(grid, tile) {
	        if (!tile.rivers)
	            return 0;
	        var coastCount = { count: 0 };
	        var NE = bitStr(isNextOrPrevRiverTile(grid, tile, tile.q + 1, tile.r - 1, coastCount));
	        var E = bitStr(isNextOrPrevRiverTile(grid, tile, tile.q + 1, tile.r, coastCount));
	        var SE = bitStr(isNextOrPrevRiverTile(grid, tile, tile.q, tile.r + 1, coastCount));
	        var SW = bitStr(isNextOrPrevRiverTile(grid, tile, tile.q - 1, tile.r + 1, coastCount));
